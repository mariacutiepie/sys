...
class Infos
{
    ...
    function add()
    {
        $sql = "INSERT INTO infos(user_id, birthday, section, bio, contact, address, email, elem, elemgrad, high, juniorgrad, shs, seniorgrad, college, collegegrad) VALUES (:user_id, :birthday, :section, :bio, :contact, :address, :email, :elem, :elemgrad, :high, :juniorgrad, :shs, :seniorgrad, :college, :collegegrad)";
