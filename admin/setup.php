...
$lastname = $firstname = $birthday = $section = $bio = $contact = $address = $email = $elem = $elemgrad = $high = $juniorgrad = $shs = $seniorgrad =  $college = $collegegrad = '';
    ...
    <div class="container mt-5">
        ...
        <form action="" method="POST">       
            ...
            <div class="col-md-4">
                ...
                <input type="text" id="bio" name="bio" class="form-control" placeholder="Enter your bio">
            </div>
            <div class="col-md-">
                <label for="facebook" class="form-label">Facebook</label>
                <input type="text" id="facebook" name="facebook" class="form-control" placeholder="Enter your Facebook link">
            </div>
            </div>
            <h3 class="mt-2">Socials</h3>
            <div class="row mb-3">
                <div class="col-md-4">
                    <label for="firstname" class="form-label">First Name <span class="error"><?= $firstnameErr ?></span></label>
                    <input type="text" id="firstname" name="firstname" class="form-control" value="<?php echo $name['firstname']?>" required>
